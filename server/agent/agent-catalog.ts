...
export const AGENT_CATALOG = {
  requirementAnalysis: {
    configurationKey: 'requirementAnalysis',
    definitionKey: 'requirement-analysis',
    scene: 'requirement_analysis',
    label: '需求分析 Agent',
    identifier: 'RequirementAnalysisAgent',
    requiredToolIds: [
      'skill.activate',
    ...
    runtimeToolIds: [...WORKSPACE_TOOLS, ...KNOWLEDGE_TOOLS, 'skill.activate'],
    exactCapabilities: false,
  },
  testDesign: {
    configurationKey: 'testDesign',
    definitionKey: 'test-design',
    scene: 'test_design',
    label: '测试设计 Agent',
    identifier: 'TestDesignAgent',
    requiredToolIds: [
      ...WORKSPACE_TOOLS,
      ...KNOWLEDGE_TOOLS,
      'skill.activate',
  ...
  testScript: {
    ...
    requiredToolIds: [...WORKSPACE_TOOLS, 'skill.activate', 'test_script.submit_result'],
    requiredSkillKeys: ['test-script-generation'],
    requiredMcpServerKeys: [],
    runtimeToolIds: [...WORKSPACE_TOOLS, 'skill.activate'],
  ...
  failureAnalysis: {
    ...
    requiredToolIds: [...WORKSPACE_TOOLS, 'skill.activate', 'failure_analysis.submit_result'],
  ...
  scriptRepair: {
    ...
    requiredToolIds: [...WORKSPACE_TOOLS, 'skill.activate', 'script_repair.submit_result'],
