...
const builtInSkills: SkillResource[] = [
  ...
  builtInSkill('test-case-design', '测试用例设计', '基于冻结 Requirement Release 生成统一、可审阅的 TestCase v3 语义候选。', '3.1.0', 'server/skills/test-case-design/SKILL.md', [], ['测试设计', '测试用例', 'TestCase v3']),
