...
const builtInSkills: SkillResource[] = [
  ...
  builtInSkill('test-script-generation', '测试脚本生成', '结合 ProjectVersion Exploration Context、固定 Knowledge 与 Execution Workspace 实现 Playwright UI 或 API Case。', '1.1.0', 'server/skills/test-script-generation/SKILL.md', [], ['测试执行', 'Playwright', '脚本生成']),
