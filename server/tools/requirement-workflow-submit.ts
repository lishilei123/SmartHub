/**
 * Release submissions are registered dynamically by the generic
 ...
 */
export const requirementWorkflowSubmitHandlers = ['requirement-release.submit_result'] as const
