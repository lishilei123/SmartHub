...
1. Read `agent_workspace/planning_agent/current-test-cases.json`, the frozen Requirement Release, and server-provided Audit blockers.
2. Repair only blockers whose `resolution` is `agent_repair`, such as an uncovered Requirement, duplicate or over-aggregated case, or invalid Requirement reference.
