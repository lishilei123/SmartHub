...
2. Submit only `test-design-repair/v3`: `schemaVersion`, `baseCandidateSha256`, complete flat `upsertCases`, and `removeCaseRefs`. Do not submit a complete Candidate or any audit-internal model, execution specification, data requirement, Finding, Confirmation, or Proposal.
