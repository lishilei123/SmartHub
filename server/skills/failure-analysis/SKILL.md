...
1. Read the frozen task, current ScriptRevision, both same-script attempts, and only the artifact metadata or excerpts supplied in the read-only workspace.
