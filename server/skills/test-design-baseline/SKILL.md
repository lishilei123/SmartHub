...
3. Read relevant API, UI, environment, technical, defect, and Knowledge material only as context. Execution facts help a later TestScriptAgent; they do not belong in TestCase v3.
