...
3. Read relevant Agent contract, technical, defect, and Knowledge material only as context. Runtime configuration belongs to the later Agent Test Run; it does not belong in TestCase v3.
