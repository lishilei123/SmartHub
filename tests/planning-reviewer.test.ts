...
function coverageRun(agentDefinition: AgentDefinitionVersion, configuration: AgentConfigurationVersion): TestDesignWorkflowRun {
  ...
  const requirementContent = { requirements: [{ clientRequirementPointId: 'REQ-1', title: '固定需求', description: '用于 Coverage Reviewer', actor: '用户', action: '操作', object: '对象', conditions: [], businessRules: [], exceptions: [], acceptanceCriteria: [], evidenceRefs: [], coverageTarget: true }], evidence: [], clarifications: [] }
  return {
