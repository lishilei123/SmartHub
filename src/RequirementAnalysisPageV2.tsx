...
function isCompleteRequirementReleaseContent(value: RequirementReleasePackage['content'] | undefined): value is RequirementReleasePackage['content'] {
  return Boolean(value && Array.isArray(value.requirements) && Array.isArray(value.evidence) && Array.isArray(value.clarifications) && Array.isArray(value.testFocus))
}
