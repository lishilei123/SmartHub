...
type SuiteDraftInput = { suiteKey: string; suiteType: 'smoke' | 'regression' | 'custom'; name: string; members: Array<{ testCaseLibraryVersionId: string; caseId: string; executionMethod: TestExecutionMethod; reason: string }> }
