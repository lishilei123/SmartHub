...
export type TestDesignWorkflowRun = TestDesignRunSummary & {
  basisSnapshot: { schemaVersion: string; projectVersionId: string; requirementReleaseId: string; verificationRunId: string; requirementReleaseContentSha256: string; content: { requirements: unknown[]; evidence: unknown[]; clarifications: unknown[] }; snapshotSha256: string; createdAt: string }
