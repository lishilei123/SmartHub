...
export type SkillResource = AiResourceBase & { kind: 'skill'; entrypoint: string; toolIds: string[]; tags: string[]; runtime?: SkillRuntimePolicy; package?: SkillPackageMetadata; contentSha256?: string }
export type ToolResource = AiResourceBase & { kind: 'tool'; source: 'builtin' | 'local' | 'http' | 'mcp'; risk: 'read' | 'network_read' | 'code_execution' | 'internal_write' | 'write_reversible' | 'write_high_risk'; timeoutMs: number; sourcePath?: string; mcpServerId?: string; endpoint?: string; authType?: 'none' | 'bearer'; credentialEnv?: string; parameters?: Record<string, unknown>; contentSha256?: string }
